        ...
        <div class="container">
            <div class="user-body">
                <form action="#" method="post" id="form" enctype="multipart/form-data">
                    ...
                    <p>
                        <input type="radio" id="neuf" name="neuf" value="N" checked>
                        <label for="neuf">Neuf</label>
                        <input type="radio" id="occasion" name="occasion" value="O">
                        <label for="occasion">Occasion</label>
                        <input type="radio" id="abime" name="abime" value="A">
                    ...
                    <p>
                        <label for="downloadImg">Photo de l'enseignant (format jpg) :</label>
                        <br>
